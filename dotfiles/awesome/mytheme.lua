...
local catppuccin = require("catppuccin_table")
local theme = {}

theme.font          = "DejaVu Sans 8"

-- Catppuccin my beloved
theme.bg_normal     = catppuccin.crust
theme.bg_focus      = catppuccin.surface0
theme.bg_urgent     = catppuccin.red
theme.bg_minimize   = "#ffffff" -- I haven't bothered
theme.bg_systray    = theme.bg_normal

theme.fg_normal     = catppuccin.peach
theme.fg_focus      = catppuccin.green
theme.fg_urgent     = "#ff0000" -- Pure red, might be bad
